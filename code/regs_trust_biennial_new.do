/**************************************************************************
	...
	regs-trust-biennial.do
	
	AC Forrester
	
	Last update: 20.12.2019
	
	Run the biennial regressions for the trust paper.
...
**************************************************************************/	
	...
	* run the specs
	...
	estout 
		using ${output}regs-biennial.tex,
		label 
		style(tex) 
		keep(*log*)
		indicate(
		...
		prehead( 
			...
			\textbf{Table \ref{table:regs-biennial}. Trust and Growth, Biennial Data} \\
